...
def generate_launch_description():
    ...
    parameters_file_path = os.path.join(parameters_file_dir, 'dual_ekf_navsat_sim.yaml')
    ...
    return LaunchDescription([
        ...
        launch.actions.DeclareLaunchArgument(
            'output_location',
	    default_value='~/master_ws/src/danitech/wagon_sensors/debug/dual_ekf_navsat_sim_debug.txt'),
